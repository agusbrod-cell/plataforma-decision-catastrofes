# Cobertura abierta de Córdoba

**Versión:** 1.0  
**Fecha de corte:** 28 de julio de 2026  
**Estado:** cobertura institucional amplia, auditable y abierta por diseño
...
La cobertura se mide sobre un universo institucional definido y versionado:

- organismos provinciales relevantes;
- organismos nacionales con datos aplicables a Córdoba;
- universidades e institutos científicos;
- los 427 gobiernos locales identificados oficialmente;
- dominios temáticos necesarios para la gestión de catástrofes.
...
- **NO LOCALIZADO:** la búsqueda fue realizada sin hallar un recurso público estructurado; no implica inexistencia.
- **PENDIENTE:** todavía no fue auditado con profundidad suficiente.
...
| Nivel | Denominación | Interpretación |
|---|---|---|
| 1 | Exploratoria | identificación inicial |
| 2 | Parcial | cobertura incompleta |
| 3 | Amplia | organismos principales y dominios críticos representados |
| 4 | Alta exhaustividad | universo casi completo y brechas explícitas |
| 5 | Sustancialmente completa | universo definido casi totalmente auditado, con revisión abierta permanente |

El Nivel 5 no equivale a conocimiento absoluto ni al cierre del catálogo.
...
Todo porcentaje deberá informar universo, numerador, denominador, fecha, criterio, exclusiones y versión.

## Criterio para publicar una versión

Una versión de Córdoba está lista para publicación cuando:

- el universo de esa versión está definido;
- todos sus organismos y dominios tienen estado;
- todos los recursos localizados están clasificados;
- cada VERDE conserva evidencia jurídica y técnica;
- cada AMARILLO declara qué falta;
- cada NO LOCALIZADO documenta la búsqueda;
- la fecha de corte está publicada;
- la revisión comunitaria continúa abierta.

Publicar una versión congela un estado reproducible del conocimiento, pero no clausura la auditoría.
...
- [Catálogo provincial](./CATALOGO_CORDOBA_FUENTES_ABIERTAS.md)
- [Auditoría ronda 2](./AUDITORIA_CORDOBA_RONDA_2_SALUD_MUNICIPIOS_AMBIENTE.md)
- [Catálogo maestro](./CATALOGO_DE_FUENTES_DE_DATOS.md)
- [Anexo latinoamericano](./ANEXO_FUENTES_LATINOAMERICA_VERIFICADAS.md)
...
La incertidumbre no se oculta: se documenta. La ausencia de evidencia no se convierte en una afirmación de inexistencia. Los estados AMARILLO, NO LOCALIZADO y PENDIENTE orientan nuevas búsquedas y permiten que terceros reproduzcan, cuestionen y mejoren la auditoría.